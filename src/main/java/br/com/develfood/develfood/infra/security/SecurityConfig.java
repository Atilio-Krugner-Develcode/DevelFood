    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return  httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST,"/pedidos/criar").permitAll()
                        .requestMatchers(HttpMethod.POST,"/avaliacao/{id}/avaliar").permitAll()
                        .requestMatchers(HttpMethod.POST,"/favoritos/prato").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST,"/client/verificar-cpf").permitAll()
                        .requestMatchers(HttpMethod.POST,"/client/verificar-telefone").permitAll()
                        .requestMatchers(HttpMethod.POST,"/client/verificar-email").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PUT,"/pedidos/mudar").permitAll()
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/favoritos/{plateId}").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET,"/restaurant/plate/{restaurantId}").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET,"/favoritos/all").permitAll()
                        .requestMatchers(HttpMethod.GET,"/client/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET,"/client/visualizar").permitAll()
                        .requestMatchers(HttpMethod.GET,"/client/visualizar").permitAll()
                        .requestMatchers(HttpMethod.GET,"/promotions/all").permitAll()
                        .requestMatchers(HttpMethod.GET,"/restaurant/{restaurantId}").permitAll()
                        .requestMatchers(HttpMethod.GET,"/restaurant/nome").permitAll()
                        .requestMatchers(HttpMethod.GET,"/pedidos/pratos").permitAll()
